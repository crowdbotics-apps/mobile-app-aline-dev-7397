...
export const get_games_list = () => ({ type: types.GET_GAMES_LIST })
export const get_games_listSucceeded = response => ({
  type: types.GET_GAMES_LIST_SUCCEEDED,
  response
})
export const get_games_listFailed = error => ({
  type: types.GET_GAMES_LIST_FAILED,
  error
})
export const get_games_read = id => ({ type: types.GET_GAMES_READ, id })
export const get_games_readSucceeded = response => ({
  type: types.GET_GAMES_READ_SUCCEEDED,
  response
})
export const get_games_readFailed = error => ({
  type: types.GET_GAMES_READ_FAILED,
  error
})
