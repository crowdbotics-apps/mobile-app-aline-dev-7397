...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.GET_GAMES_LIST_SUCCEEDED:
    case types.GET_GAMES_LIST_FAILED:
    case types.GET_GAMES_READ:
    case types.GET_GAMES_READ_SUCCEEDED:
    case types.GET_GAMES_READ_FAILED:
